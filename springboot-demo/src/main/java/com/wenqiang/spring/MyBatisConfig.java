...
import com.wenqiang.util.DynamicDataSource;
...
@MapperScan(basePackages = "com.wenqiang.dao")
public class MyBatisConfig {
    ...
    public DynamicDataSource dataSource(@Qualifier("myTestDbDataSource") DataSource myTestDbDataSource,
        ...
        targetDataSources.put(DatabaseType.shiro, myTestDbDataSource);
        targetDataSources.put(DatabaseType.utilmysql, myTestDb2DataSource);
